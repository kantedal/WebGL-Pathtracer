...
export class NavigatorService {
  ...
  constructor() {
    this._broadcaster = new BroadcasterService();
  }
  ...
  public fire(channel: string, data: any): void {
    this._broadcaster.broadcast(channel, data);
  }

  public on(channel: string): Observable<any> {
    return this._broadcaster.on<string>(channel);
  }
}
